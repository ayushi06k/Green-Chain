    ...
    <div className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <aside className="fixed left-4 top-16 w-1/5 p-4 bg-gray-900 rounded-lg min-h-[80vh]">
        <div className="flex flex-col items-center text-center">
          ...
          />
          <h3 className="mt-2 text-lg font-semibold">Dr.Prashant Sharma</h3>
      ...
      <div className="ml-[22%] p-8">
        ...
        <header className="flex justify-between items-center py-4">
          <nav className="flex space-x-4 text-sm">
            ...
            <button className="px-4 py-2 bg-gray-800 rounded-lg">Research Papers</button>
          </nav>
        ...
        <section className="mt-6">
          ...
          <h1 className="text-5xl font-bold mt-4">Dr.Prashant Sharma</h1>
          ...
          <p className="mt-4 text-gray-300 max-w-2xl">
            Hi, I am Dr. Prashant Sharma, Professor in SRM University Chennai </p>
        </section>
